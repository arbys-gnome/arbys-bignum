...
namespace arbys::bignumbers::errors {
    ...
    [[nodiscard]] constexpr std::string_view to_string(const ParseError error) noexcept {
        switch (error) {
            case ParseError::EmptyInput:       return "Empty input string";
            case ParseError::InvalidCharacter: return "Invalid character in input";
            case ParseError::InvalidSeparator: return "Invalid separator in input";
            case ParseError::NoDigits:         return "No digits found";
            case ParseError::InvalidBase:      return "Invalid base";
        }
    ...
    [[nodiscard]] constexpr std::string_view to_string(const ArithmeticError error) noexcept {
        switch (error) {
            ...
            case ArithmeticError::Overflow:        return "Arithmetic overflow";
            case ArithmeticError::Underflow:       return "Arithmetic underflow";
            case ArithmeticError::InvalidOperation: return "Invalid operation";
        }
